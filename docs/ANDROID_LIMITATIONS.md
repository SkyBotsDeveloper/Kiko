...
The repo-local trainer currently exports a log-mel feature model. Android now
includes a Kiko log-mel adapter for pipeline testing, but real wake detection
quality still depends on better training data, threshold tuning, and real-phone
battery/noise validation.
